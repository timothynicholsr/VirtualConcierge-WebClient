...
//                                 echo '<pre>' . var_export($language->buttons, true) . '</pre>';
//
        ...
        <style>
            ...
            .contentBox {
                background: url(<?php echo $data['background_image_two']?>) no-repeat top center;
            }
            ...
            .contentBox .navBox li a:hover {
                background: <?php echo $background_color_b;?>;
            }

            .contentBox .navBox:before {
                content: "";
                position: absolute;
                left: 0px;
                top: 0px;
                width: 100%;
                height: 100%;
            <?php echo ($rgb_Color !='' ?  "background:$rgb_Color;": '');?> !important;
                z-index: -1;
            }

            .footer .change-lang .dropdown .submenu li a:hover {
                color: #fff;
                background: <?php echo $background_color_b;?>;
            }

            .footer .change-lang .dropdown .submenu li a {
